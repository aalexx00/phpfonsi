	...
	<header>
		...
		<div class="options-place">
			...
			if (isset($_SESSION['codusu'])) {
				...
				'<div class="item-option" title="Ingresar"><i class="fa fa-sign-in" aria-hidden="true"><a href="/finalizar.php">Salir</a></i></div>'?>
			<?php
			}else{
			?>
			<div class="item-option" title="Ingresar"><i class="fa fa-sign-in" aria-hidden="true"><a href="/login.php">Ingresar</a></i></div>
			<?php
			}
			?>
